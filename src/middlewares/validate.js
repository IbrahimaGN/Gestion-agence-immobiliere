...
const valider = (schema, source = 'body') => {
  return (req, res, next) => {
    ...
    // abortEarly permet de collecter toutes les erreurs de validation au lieu de s'arrêter à la première, 
    // et stripUnknown supprime les champs qui ne sont pas définis dans le schéma
